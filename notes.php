<?php
include('sessionC.php');// Starting Session
$connection = mysqli_connect("localhost", "root", "","swimclub");

$firstname =$row['firstname'];

$query = mysqli_query($connection, "SELECT fname FROM members WHERE Coach ='$firstname'")or die(mysqli_error($db));
...
<body>
	...
	<th>Notes</th>
		...
		<br>
		<form class="contact-form" method="post" action="notesaction.php">
...
<tr>
	...
	<input type="hidden" name="Notes_Id" placeholder="Notes_Id">
					</div></td>
				<td>	<input type="text" value="<?php echo $name;?>" name="Member[]">
				</td>
				<td>
			    <div class="col-md-6">
	<input type="number" name="Notes[]" placeholder="Notes" required="required">
					</div></td>
	
	<td> <div class="col-md-6">
	<input type="hidden" name="Coach[]" placeholder="Notes_Id"><?php echo $firstname ?>
					</div></td>
			...
			<div class="col-md-12">
				<input type="Submit" name="Submit" class="site-btn" value="Submit"/></div>
			</form>	
